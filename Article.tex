...
are of cuspidal type or shallow tails. This is well describe in a paper of E. Ghys \cite{ghys} introducing Chebyshev net on surfaces. It is not known
...
$$\partial ^2 _{uv} \omega = -K(u,v) \sin 2 \omega (u,v).$$
...
in the same point $p$. In this case, the bifurcation point is related to a "cross". However the number of twin crystal line which meet together at
 ...
 The first non local result has been proved by I. Ya. Bakelman. He  proved the existence of Chebyshev coordinates in any sector bounded by two orthogonal geodesics on a
...
\begin{theorem}[Existence and uniqueness of Chebyshev nets]\label{thm2smooth}
